"""AdamW that is compatible with complex parameters.

Adapted from https://github.com/pytorch/pytorch/blob/master/torch/optim
See discussion in https://github.com/pytorch/pytorch/issues/59998
The only change is in line 46.
"""
...
@Optimizer.register("adamw_complex")
