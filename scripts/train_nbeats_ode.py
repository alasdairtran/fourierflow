...
class TimeSeriesODE(pl.LightningModule):
    def __init__(self,
                 ...
                 dropout=0.1):
        super().__init__()
        self.in_proj = GehringLinear(backcast_length, hidden_size)
        ...
        # f = NBeatsNet(device=torch.device('cuda:0'),
        #               stack_types=[NBeatsNet.GENERIC_BLOCK] * n_stacks,
        #               nb_blocks_per_stack=nb_blocks_per_stack,
        #               forecast_length=hidden_size,
        #               backcast_length=hidden_size,
        ...
        # self.model = NeuralDE(f, sensitivity='adjoint', solver='dopri5')
        self.model = NeuralDE(f, sensitivity='autograd', solver='rk4')
        self.out_proj = GehringLinear(hidden_size, 1)
